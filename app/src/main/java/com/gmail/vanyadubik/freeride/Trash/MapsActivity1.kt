...
class MapsActivity1 : AppCompatActivity(), OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    override fun showLocations(addresses: MutableList<Address>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    override fun showDebouncedLocations(addresses: MutableList<Address>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    override fun showLocationInfo(addresses: MutableList<Address>?) {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
