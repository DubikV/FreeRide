...
public class DotProgressBar extends View {
  ...
  private BounceAnimation bounceAnimation = new BounceAnimation();
  ...
  private void initializeAttributes(AttributeSet attrs) {
    if (attrs != null) {
      ...
      setStartColor(ContextCompat.getColor(getContext(), R.color.colorPrimaryDark));
      setEndColor(ContextCompat.getColor(getContext(), R.color.colorPrimaryDark));
